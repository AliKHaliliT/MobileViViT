...
class MobileViViTS(tf.keras.Model):

    """
    
    MobileViViT-S Variant Architecture
    The architecture is based on the MobileViT-S variant from 
    ...
    Given the parameters in the paper, the model has around 25 million parameters.
    ...
    def __init__(self, num_output_units) -> None:
        ...
        Constructor of the MobileViViT-S model.
        ...
        # Backbone
        ## Stage 1
        self.mvnblock_1 = MVNBlock(expansion_filters=64 * expansion_factor, filters=24, 
                                   kernel_size=(3, 3, 3), strides=(2, 2, 2), 
                                   padding="same", activation="hard_swish")
        self.mvnblock_2 = MVNBlock(expansion_filters=64 * expansion_factor, filters=24,
                                   kernel_size=(3, 3, 3), strides=(1, 1, 1), 
                                   padding="same", activation="hard_swish")
        self.mvnblock_3 = MVNBlock(expansion_filters=64 * expansion_factor, filters=24,
                                   kernel_size=(3, 3, 3), strides=(1, 1, 1), 
                                   padding="same", activation="hard_swish")

        ## Stage 2
        self.mvnblock_4 = MVNBlock(expansion_filters=96 * expansion_factor, filters=48,
                                   kernel_size=(3, 3, 3), strides=(2, 2, 2), 
                                   padding="same", activation="hard_swish")
        self.mobilevivit = MobileViViT(projection_dim=144, kernel_size=[(3, 3, 3), (3, 3, 3)],
                                       strides=(1, 1, 1), padding="same", patch_size=(1, 2, 2), 
                                       num_transformer_layers=2)
        
        ## Stage 3
        self.mvnblock_5 = MVNBlock(expansion_filters=128 * expansion_factor, filters=64,
                                   kernel_size=(2, 3, 3), strides=(1, 1, 1), 
                                   padding="same", activation="hard_swish")
        self.mobilevivit_1 = MobileViViT(projection_dim=192, kernel_size=[(2, 3, 3), (2, 3, 3)],
                                         strides=(1, 1, 1), padding="same", patch_size=(1, 2, 2), 
                                         num_transformer_layers=4)
        
        ## Stage 4
        self.mvnblock_6 = MVNBlock(expansion_filters=160 * expansion_factor, filters=80,
                                   kernel_size=(1, 3, 3), strides=(1, 1, 1), 
                                   padding="same", activation="hard_swish")
        self.mobilevivit_2 = MobileViViT(projection_dim=240, kernel_size=[(1, 3, 3), (1, 3, 3)],
                                         strides=(1, 1, 1), padding="same", patch_size=(1, 2, 2), 
                                         num_transformer_layers=3)
        self.conv_layer_1 = ConvLayer(filters=640, kernel_size=(1, 1, 1), strides=(1, 1, 1),
                                        padding="same", batch_norm=False, activation="hard_swish")
    ...
    def call(self, X) -> tf.Tensor:
        ...
        Call method of the MobileViViT-S model.
