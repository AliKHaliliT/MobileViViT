import unittest
from MobileViViT.assets.blocks.transformer import Transformer
...
class TestTransformer(unittest.TestCase):
    ...
    def test_num__transformer__layers_wrong__type_type__error(self):
        ...
        with self.assertRaises(TypeError):
            Transformer(num_transformer_layers=num_transformer_layers, projection_dim=1, 
    ...
    def test_projection__dim_wrong__type_type__error(self):
        ...
        # Act and Assert
        with self.assertRaises(TypeError):
            Transformer(num_transformer_layers=1, projection_dim=projection_dim, 
                        num_transformer_heads=1)
    ...
    def test_num__transformer__heads_wrong__type_type__error(self):
        ...
        # Act and Assert
        with self.assertRaises(TypeError):
            Transformer(num_transformer_layers=1, projection_dim=1, 
    ...
    def test_dropout__mha_wrong__type_type__error(self):
        ...
        with self.assertRaises(TypeError):
            Transformer(num_transformer_layers=1, projection_dim=1, 
                        num_transformer_heads=1, dropout_mha=dropout_mha)
    ...
    def test_aproximator__type_wrong__type_type__error(self):
        ...
        with self.assertRaises(TypeError):
            Transformer(num_transformer_layers=1, projection_dim=1, 
                        num_transformer_heads=1, aproximator_type=aproximator_type)
    ...
    def test_activation_wrong__type_type__error(self):
        ...
        with self.assertRaises(TypeError):
            Transformer(num_transformer_layers=1, projection_dim=1, 
                        num_transformer_heads=1, activation=activation)
    ...
    def test_dropout__mlp_wrong__type_type__error(self):
        ...
        with self.assertRaises(TypeError):
            Transformer(num_transformer_layers=1, projection_dim=1, 
                        num_transformer_heads=1, dropout_mlp=dropout_mlp)
    ...
    def test_input__error_not__tensor_type__error(self):
        ...
        with self.assertRaises(TypeError):
            Transformer(num_transformer_layers=1, projection_dim=1, 
                        num_transformer_heads=1)(input_tensor)
    ...
    def test_output_tensor_intended__shape(self):
        ...
        # Act
        output = Transformer(num_transformer_layers=1, projection_dim=1, 
                             num_transformer_heads=1)(input_tensor)
    ...
    def test_get__config_layer_non__empty__dict(self):
        ...
        # Arrange and Act
        config = Transformer(num_transformer_layers=1, projection_dim=1, 
                             num_transformer_heads=1).get_config()
    ...
    def test_from__config_layer__config__dict_input__config__dict(self):
        ...
        # Act
        cloned_layer = Transformer(num_transformer_layers=1, projection_dim=1, 
                                   num_transformer_heads=1).from_config(config)
